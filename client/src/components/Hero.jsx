      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            {/* Small Eyebrow */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-surface/90 border border-border text-accent text-xs font-mono tracking-wider uppercase mb-6 shadow-xl dark:shadow-none">
            ...
            {/* Supporting Headline */}
            <p className="text-lg sm:text-xl text-muted font-normal leading-relaxed max-w-2xl mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-4 w-full sm:w-auto mb-10">
              ...
              <Link
                to="/services"
                className="px-7 py-4 rounded-xl glass-panel text-secondary hover:text-primary font-semibold text-sm hover:bg-white/50 dark:hover:bg-slate-800/80 transition-all duration-300 flex items-center justify-center gap-2 border border-border"
              >
            ...
            <div className="pt-6 border-t border-border w-full">
              <div className="text-xs font-mono uppercase tracking-widest text-muted mb-3 flex items-center justify-center lg:justify-start gap-2">
              ...
              <div className="text-xs font-medium text-muted flex flex-wrap items-center justify-center lg:justify-start gap-x-4 gap-y-2">
                <span className="hover:text-accent transition-colors">Technical SEO</span>
                <span className="text-slate-300 dark:text-slate-700">•</span>
                <span className="hover:text-accent transition-colors">Content Strategy</span>
                <span className="text-slate-300 dark:text-slate-700">•</span>
                <span className="hover:text-accent transition-colors">Local SEO</span>
                <span className="text-slate-300 dark:text-slate-700">•</span>
                <span className="hover:text-accent transition-colors">E-commerce SEO</span>
                <span className="text-slate-300 dark:text-slate-700">•</span>
                <span className="hover:text-accent transition-colors">SEO Analytics</span>
              </div>
            </div>
