      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          <div className="lg:col-span-8">
            ...
            <p className="text-xl text-slate-300 font-normal leading-relaxed mb-8">
              {service.shortDesc}
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <button
                onClick={onOpenAudit}
                className="px-7 py-3.5 rounded-xl bg-gradient-to-r from-cyan-500 to-emerald-500 font-semibold text-slate-950 text-sm shadow-xl shadow-cyan-500/20 hover:opacity-95 transition-opacity flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-7 py-3.5 rounded-xl glass-panel text-slate-200 hover:text-white font-semibold text-sm border border-slate-800"
              >
          ...
          <div className="lg:col-span-4 flex justify-center">
            <div className="w-40 h-40 rounded-3xl bg-slate-950 border border-slate-800 flex items-center justify-center text-cyan-400 shadow-2xl relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-20">
                ...
                {service.features.map((feat, idx) => (
                  <div key={idx} className="p-4 rounded-xl bg-slate-950 border border-slate-800/80">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-white mb-1">{feat}</div>
                        <div className="text-xs text-slate-400">Custom tailored to match your specific domain tech stack and search volume.</div>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="glass-card rounded-2xl p-6 border border-slate-800">
              <div className="text-xs font-mono text-cyan-400 uppercase mb-3">EXPECTED OUTCOMES</div>
              <div className="space-y-3 font-mono text-xs text-slate-300">
                <div className="flex justify-between border-b border-slate-800 pb-2">
                  <span>Crawl Efficiency</span>
                  <span className="text-emerald-400 font-bold">+140%</span>
                </div>
                <div className="flex justify-between border-b border-slate-800 pb-2">
